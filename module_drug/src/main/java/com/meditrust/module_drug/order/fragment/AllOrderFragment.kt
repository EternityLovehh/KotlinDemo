 ...
 * @desc:
 */
class AllOrderFragment : BaseListFragment<BaseItem, FragmentOrderListBinding, OrderViewModel>() {
    ...
    override fun initData() {
        ...
        mViewModel.observeAdapterObserver(this,
            { position, payload -> mOrderAdapter.notifyItemChanged(position, payload) },
            { position -> mOrderAdapter.notifyItemRemoved(position) })
